...
echo "  Package Name: ${PACKAGE_NAME:-com.hackmit2025.helloworld}"
echo "  Port: ${PORT:-3000}"
...
if curl -s http://localhost:3000/health > /dev/null 2>&1; then
    ...
    echo "⚠️  Server may not be running or health endpoint not available"
fi
...
echo "2. The app shows 'com.hackmit2025.helloworld'"
